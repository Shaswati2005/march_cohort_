...
export default function Home() {
  ...
  const locations= [
    ...
    {label:'raipur', value:'delhi'},
    {label:'shimla', value:'delhi'},
    {label:'puri', value:'delhi'},
    {label:'kolkata', value:'delhi'}
  ]
    ...
    <div className="w-screen h-full bg1 " >
      ...
      <div className="pt-30 flex flex-col   gap-10 items-center lg:items-start justify-end  lg:p-30 p-20">
        <div className=" flex-col gap-10">
          <h1 className="font-extrabold  text-5xl lg:text-9xl text-white ">om travels</h1>
          <h2 className="lg:pl-[30%] pl-[5%] tgowild font-stretch-ultra-expanded  text-lg lg:text-3xl">lets personalise yoour travels</h2>
        </div>
        <div className="lg:px-45 lg:py-20">
        <button className="lg:text-2xl lg:px text-lg text-white w-40 bg-[#6ca22d] lg:w-50 py-3 border-1 rounded-sm hover:bg-white hover:text-[#7bb471] hover:shadow-2xs shadow-[#8bc34a] hover:scale-105 transition-all ">
          lets get started
        </button>
      ...
      <div className="h-full w-screen  py-10 md:py-20 flex flex-col items-center justify-center bg-white text-black z-10">
        ...
        <div className="flex flex-col lg:flex-row  items-center gap-1 ">
          <div className="  w-60 h-20 hover:shadow-2xl hover:scale-105 shadow-[#6ca22d] p-3 transition-all  text-[#6ca22d] border border-[#6ba22d31]">
            <Dropdown title="locations" label="locations" items={locations} onSelect={handleLocationSelect}/>
          </div>
          <div className="  w-60 h-20 hover:shadow-2xl hover:scale-105 shadow-[#6ca22d] p-3 transition-all  text-[#6ca22d] border border-[#6ba22d31]">
            <Dropdown title="locations" label="locations" items={locations} onSelect={handleLocationSelect}/>
          </div>
      ...
      <div  className="px-20 py-20 w-screen h-full  flex items-start  justify-center gap-5">
        <input type="string" placeholder="search locations"  className="px-5 py-2  bg-[#6ba22d27] text-[#5da110] w-100 rounded-full text-start h-full">
      ...
      <div className="px-20 py-20 w-screen h-full  flex items-center justify-center">
        <div className="px-5 py-2 rounded-lg bg-[#6ba22d27] text-[#5da110] w-50 text-center h-full">popular activities</div>
      </div>
      ...
      <div className="flex flex-row items-center justify-between pl-20 ">
        ...
        <div>
          ...
          <div className="px-5 py-2 rounded-lg bg-[#6ba22d27] text-[#5da110] w-50 text-center h-full">About Company</div>
          </div>
